...
namespace PmcReader.Intel
{
    public class AlderLake : ModernIntelCpu
    {
        ...
        public class ALUPortUtilization : MonitoringConfig
        {
            ...
            public ALUPortUtilization(AlderLake intelCpu)
            {
                cpu = intelCpu;
            }
        ...
        public class L2Cache : MonitoringConfig
        {
            ...
            public L2Cache(AlderLake intelCpu)
            {
                cpu = intelCpu;
            }
        ...
        public class MemLoads : MonitoringConfig
        {
            ...
            public MemLoads(AlderLake intelCpu)
            {
                cpu = intelCpu;
            }
        ...
        public class OffcoreBurst : MonitoringConfig
        {
            ...
            public OffcoreBurst(AlderLake intelCpu)
            {
                cpu = intelCpu;
            }
        ...
        public class ResourceStalls : MonitoringConfig
        {
            ...
            public ResourceStalls(AlderLake intelCpu)
            {
                cpu = intelCpu;
            }
        ...
        public class DataPageWalk : MonitoringConfig
        {
            ...
            public DataPageWalk(AlderLake intelCpu)
            {
                cpu = intelCpu;
            }
        ...
        public class ICache : MonitoringConfig
        {
            ...
            public ICache(AlderLake intelCpu)
            {
                cpu = intelCpu;
            }
        ...
        public class MemBound : MonitoringConfig
        {
            ...
            public MemBound(AlderLake intelCpu)
            {
                cpu = intelCpu;
            }
        ...
        public class Fp32Flops : MonitoringConfig
        {
            ...
            public Fp32Flops(AlderLake intelCpu)
            {
                cpu = intelCpu;
            }
        ...
        public class Locks : MonitoringConfig
        {
            ...
            public Locks(AlderLake intelCpu)
            {
                cpu = intelCpu;
            }
